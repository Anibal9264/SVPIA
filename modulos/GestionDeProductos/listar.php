...
?>
    ...
    <br>
		<div>
                    <a class="btn btn-success" href="./index.php?p=formProduct">Nuevo <i class="fa fa-plus"></i></a>
		</div>
		<br>
			...
			<tbody id="Bproductos">
				...
				<tr>
					...
					<td><a class="btn btn-warning" href="<?php echo "index.php?p=editProduct&id=" . $producto->id?>"><i class="fa fa-edit"></i></a></td>
