...
?>
    ...
    <br>
		<div>
                    <a class="btn btn-success" href="index.php?p=formularioIngreso">Nuevo <i class="fa fa-plus"></i></a>
		</div>
			...
			<tbody id="BIngresos">
				...
				<tr>
					...
					<td><a class="btn btn-warning" href="<?php echo "index.php?p=editIngreso&id=" . $ingreso->id?>"><i class="fa fa-edit"></i></a></td>
