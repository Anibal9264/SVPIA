...
$sentencia = $base_de_datos->prepare("SELECT sum(cantidad) as tProductos from SVPIA.productos_vendidos");
$sentencia->execute();
$tProductos = $sentencia->fetch(PDO::FETCH_OBJ);
$t = (float) $tProductos->tProductos;
$porcentaje = (100.00 / $t);
?>
<body>
<div class="container">
        ...
        <div class="col-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php
                    $primero = (int) $porcentaje * $productos[0]->sumaC . "%";
                    $segundo = (int) $porcentaje * $productos[1]->sumaC . "%";
                    $tercero = (int) $porcentaje * $productos[2]->sumaC . "%";
                    $cuarto = (int) $porcentaje * $productos[3]->sumaC . "%";
                    $quinto = (int) $porcentaje * $productos[4]->sumaC . "%";
                    ?>
